...
from exchange_catalogue_50.s100.pkg_5.pkg_0.pkg_0.s100_catalog.pkg_20220705.maintenance import MdMaintenanceInformationPropertyType
from exchange_catalogue_50.s100.pkg_5.pkg_0.pkg_0.s100_se.pkg_20220728.part15 import (
...
from exchange_catalogue_50.schemas.isotc211.org.pkg_19115.pkg_minus_3.gex.pkg_1.pkg_0.extent import (
...
from exchange_catalogue_50.schemas.isotc211.org.pkg_19115.pkg_minus_3.mco.pkg_1.pkg_0.constraints import MdClassificationCodePropertyType
from exchange_catalogue_50.schemas.isotc211.org.pkg_19115.pkg_minus_3.mri.pkg_1.pkg_0.identification import MdUsagePropertyType

__NAMESPACE__ = "http://www.iho.int/s100/xc/5.0"
...
class S100ExchangeCatalogueIdentifier:
    ...
    class Meta:
        ...
        namespace = "http://www.iho.int/s100/xc/5.0"
...
class S100ResourcePurpose(Enum):
    ...
    :cvar DATASET: A dataset
    :cvar FEATURE_CATALOGUE: A Feature Catalogue for an S-100 data
        product
    :cvar PORTRAYAL_CATALOGUE: A Portrayal Catalogue for an S-100 data
        product
    :cvar INTEROPERABILITY_CATALOGUE: An Interoperability Catalogue
    :cvar SUPPORT_FILE: A support file
    :cvar PRODUCT_VERSION: All datasets conforming to a specific version
        of an S-100 Product Specification
    :cvar PRODUCT_FAMILY: All datasets conforming to any active version
        of an S-100 Product Specification
    :cvar SOFTWARE: Application software
    :cvar SYSTEM: Provides support or common information for a variety
        of applications and products
    :cvar EXCHANGE_CATALOGUE: An Exchange Catalogue
...
class S100SupportFileFormat(Enum):
    ...
    :cvar ASCII: UTF-8 text excluding control codes
    ...
    class DigitalSignatureValue:
        s100_se_signature_on_data: Optional[S100SeSignatureOnData] = field(
            ...
            metadata={
                ...
                "type": "Element",
                "namespace": "http://www.iho.int/s100/se/5.0",
            }
        )
...
class S100DataCoverage:
    ...
    bounding_polygon: List[S100BoundingPolygonType] = field(
        default_factory=list,
        metadata={
...
class S100DatasetDiscoveryMetadata:
    ...
    :ivar replaced_data: If a data file is cancelled is it replaced by
        another data file

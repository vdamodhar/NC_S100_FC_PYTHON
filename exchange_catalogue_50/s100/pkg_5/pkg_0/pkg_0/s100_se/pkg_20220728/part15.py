...
from exchange_catalogue_50.schemas.isotc211.org.pkg_19115.pkg_minus_3.gco.pkg_1.pkg_0.base_types import NilReasonEnumerationValue

__NAMESPACE__ = "http://www.iho.int/s100/se/5.0"
...
class S100SeCertificateContainerType:
    ...
    class SchemeAdministrator:
        """
        :ivar id: The scheme administrator identity
        """
        id: Optional[str] = field(
            default=None,
            metadata={
...
class PermitType:
    ...
    :ivar products: Permits from the Data Server for the specified
        product
    """
    header: Optional[PermitHeaderType] = field(
        default=None,
        metadata={
            "type": "Element",
            "namespace": "http://www.iho.int/s100/se/5.0",
    ...
    products: Optional[ProductsPermitType] = field(
        default=None,
        metadata={
            "type": "Element",
            "namespace": "http://www.iho.int/s100/se/5.0",
